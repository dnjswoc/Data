...
# 1️⃣ CSV 파일 불러오기
file1 = "서울특별시_행정동별_선호항목_최종점수.csv"  # 기준 파일
file2 = "서울특별시_행정동_이름수정.csv"  # 비교 파일
